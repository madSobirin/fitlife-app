    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <div className="flex flex-1 w-full min-h-screen">
        <div className="hidden lg:flex w-[45%] xl:w-[50%] relative items-center justify-center p-8 lg:p-16">
          ...
          <motion.div
            initial={{ opacity: 0, x: -50 }} // Posisi awal: agak ke kiri & transparan
            animate={{ opacity: 1, x: 0 }} // Posisi akhir: normal
          ...
          >
            <div className="aspect-square relative w-full max-w-[600px] mx-auto">
              {/* 3. ANIMASI FLOATING (MELAYANG)
                  Ini membuat gambar naik turun perlahan agar terlihat seperti 3D
              */}
              <motion.div
                animate={{ y: [0, -20, 0] }} // Gerak: Titik 0 -> Naik 20px -> Balik ke 0
                transition={{
                  duration: 6, // Waktu satu putaran (naik-turun)
            ...
            <div className="mt-8 max-w-md mx-auto text-center lg:text-left">
              ...
              {/* Optional: Animasi Teks muncul belakangan */}
              <motion.h2
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3, duration: 0.8 }} // Delay dikit biar muncul setelah gambar
                className="text-3xl xl:text-4xl font-black tracking-tighter leading-tight text-gray-900 dark:text-white"
              >
                Design your body.
                <br />
                Defy your limits.
        ...
        <div className="w-full lg:w-[55%] xl:w-[50%] flex flex-col justify-center items-center p-6 sm:p-12 lg:p-20 bg-background-light dark:bg-background-dark z-10">
          <div className="w-full max-w-[480px] space-y-8 animate-fade-in-up">
            <div className="space-y-2">
              <h1 className="text-2xl md:text-4xl font-black tracking-[-0.03em] text-[#111814] dark:text-white">
                {title}
              </h1>
            ...
            <div className="text-center pt-4">
              <span className="text-xs md:text-sm text-gray-500 font-medium mr-1 dark:text-gray-400">
                {alternativeAuth.text}
              </span>
              <Link
                href={alternativeAuth.href}
                className="text-xs md:text-sm font-bold text-[#111814] dark:text-white underline hover:text-primary transition-colors duration-200"
              >
                {alternativeAuth.linkText}
              </Link>
            </div>
